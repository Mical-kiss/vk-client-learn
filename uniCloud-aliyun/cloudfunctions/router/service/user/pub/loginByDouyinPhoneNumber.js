module.exports = {
	/**
	 * 用户登录（抖音手机号授权登录）
	 * @url user/pub/loginByDouyinPhoneNumber 前端调用的url参数地址
	 * data 请求参数 说明
	...
	main: async (event) => {
		...
		// 获取抖音绑定的手机号
		res = await vk.openapi.douyin.decrypt.getPhoneNumber({
			encryptedKey,
			code,
			encryptedData,
			iv
